                ...
                <div className="canvas">
                    ...
                    <div id="card">
                        <div className="card-content">
                            ...
                            <div className="title">{name.split(' ')[0]}<br />{name.split(' ')[1]}</div>
                            ...
                            <div className=" flex w-full h-full justify-center items-center">
                                <div className="imgContainer" >
                                    <img src={Images[imgIdx-1]} alt={name} />
                                </div>
                            </div>
...
const StyledWrapper = styled.div`
    ...
    #card {
        ...
        border-radius: 20px;
        transition: 700ms;
        background: linear-gradient(45deg, rgba(26, 26, 26, 0.51), rgba(38, 38, 38, 0.56));
